...
namespace SimpleSpritePackerEditor
{
	public class SPTools
	{
		...
		public static bool CreateBlankTexture(string path, bool alphaTransparency)
		{
			...
			var pa = textureImporter.GetDefaultPlatformTextureSettings ();
			pa.textureCompression = TextureImporterCompression.CompressedLQ;

			textureImporter.SetPlatformTextureSettings (pa);
