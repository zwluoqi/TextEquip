...
public class TextureFunc : Editor
{
	...
	public static void SelectTex (bool resize)
	{
		...
		foreach (var s in selects) {
			...
			SimpleSpritePackerEditor.SPTools.AssetSetReadWriteEnabled (path, true, true);
			SimpleSpritePackerEditor.SPTools.AssetSetFormat (path, TextureImporterFormat.ARGB32);
	...
	static void Resize (int sizeX,int sizeY)
	{
		...
		foreach (var s in selects) {
			...
			SimpleSpritePackerEditor.SPTools.AssetSetReadWriteEnabled (path, true, true);
			SimpleSpritePackerEditor.SPTools.AssetSetFormat (path, TextureImporterFormat.ARGB32);
			SimpleSpritePackerEditor.SPTools.AssetSetCompresss (path, TextureImporterCompression.Uncompressed);
	...
	public static void CombineTex ()
	{
		...
		foreach (var s in selects) {
			...
			SimpleSpritePackerEditor.SPTools.AssetSetReadWriteEnabled ("Exports/Res/GoodIcon/juanzhou/juanzhou.png", true, true);
			SimpleSpritePackerEditor.SPTools.AssetSetFormat ("Exports/Res/GoodIcon/juanzhou/juanzhou.png", TextureImporterFormat.ARGB32);
