...
//				XZXDDebug.LogWarning (bundlePath + " HandlerLoadAssetBundleWithDepedence:" + de);
//				LoadAssetBundle (de);
...
//				}
//
//				RunCoroutine.Run (LoadAssetBundleAsync (bundlePath,
//					(_bundlePath, _ab) => {
//						HandlerLoadAssetBundleAsync (bundlePath, assetName, act);
//					}
//				));
...
//
//			foreach (var de in dependencies) {
//				XZXDDebug.LogWarning (bundlePath + " HandlerLoadAssetBundleAsyncWithDepedence:" + de);
//
//				RunCoroutine.Run (LoadAssetBundleAsync (de,
//					(_de, _de_ab) => {
...
//			XZXDDebug.LogWarning ("bundle path:" + bc.Key + " count:" + bc.Value.count);
//		}
//		foreach (var ac in assetDicts) {
//			XZXDDebug.LogWarning ("bundle assetObject path:" + ac.Key + " count:" + ac.Value.count);
//		}
//	}
//
//	#endregion
