...
//    private string prefabName;
    ...
    //最大存储数量
    private int maxAvailableCount = 50;

    public GameObjectPool(GameObject obj, int preNum, int id)
    {
//        prefabName = name;
        prefabAsset = obj;
        this.id = id;
...
//    {
//		if (unActiveObjects.Count == allObjects.Count)
//			return;
//		unActiveObjects.Clear ();
//		unActiveObjects.AddRange (allObjects);
...
//    }
	...
	public void UnspawnAllAndDestroy(){
