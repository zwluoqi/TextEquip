...
public partial class DictSystemQuestion
{
    ...
    public class Model
    {
     ...
     /// <summary>
        /// 正确答案
        /// </summary>
        public XorInt questionAnswer_xor;
     /// <summary>
        /// 正确答案
        /// </summary>
        public int questionAnswer{
            get{
                return questionAnswer_xor.val;
            }
        }
     /// <summary>
        /// 作者
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictSystemQuestion m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_system_question.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.answers = DictTypeConvert.ParseArrayString(str[fileReader.typeName2Index["answers"]]);
            model.questionAnswer_xor = new XorInt( DictTypeConvert.ParseInt(str[fileReader.typeName2Index["questionAnswer"]]),fileReader.randomUtil);
            model.zuozhe = DictTypeConvert.ParseString(str[fileReader.typeName2Index["zuozhe"]]);
            ...
            {
                Debug.LogError("DictSystemQuestion Parse:Same Key = " + model.id);
            }
