...
public partial class DictExample
{
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictExample m_dict Is Null");
            return null;
        }
        else
        {
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.firstname = DictTypeConvert.ParseString(str[fileReader.typeName2Index["firstname"]]);
            ...
            {
                Debug.LogError("DictExample Parse:Same Key = " + model.id);
            }
