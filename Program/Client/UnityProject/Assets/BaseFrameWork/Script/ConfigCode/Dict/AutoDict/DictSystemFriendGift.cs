...
public partial class DictSystemFriendGift
{
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictSystemFriendGift m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_system_friend_gift.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            {
                Debug.LogError("DictSystemFriendGift Parse:Same Key = " + model.id);
            }
